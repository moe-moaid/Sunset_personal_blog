...
function sunset_posted_meta() {
	...
	return '<span class="posted-on">Posted <a href="' . esc_url( get_permalink() ) .'">' . $posted_on . ' ago</span> / <span class="posted-in">' . $output . '</span>';
}
...
function sunset_posted_footer() {
	...
	return '<div class="post-footer-container"><div class="row"><div class="tags-side col-xs-12 col-sm-6"> '. get_the_tag_list ( '<div class="tags-list"><span class="sunset-icon sunset-tag"></span>', ' ', '</div>' ) .' </div><div class="comments-side col-xs-12 col-sm-6 text-end"> ' .$comments. ' </div></div></div>';
}
...
//retrieve a link inside link format post 
...
function sunset_post_navigation(){
	...
	$prev = get_previous_post_link( '<div class="postlink-nav-previous"><span class="sunset-icon sunset-chevron-left" aria-hidden="true"></span> %link</div>', '%title' );
	$nav .= '<div class="col-xs-12 col-sm-6">'. $prev .'</div>';

	$next = get_next_post_link( '<div class="postlink-nav-next">%link <span class="sunset-icon sunset-chevron-right" aria-hidden="true"></span></div>', '%title' );
...
//share links section in single post pages
function sunset_share_this( $content ){

	if( is_single() ){

		$content .= '<div class="sunset-shareThis"><h5>Share This Post</h5>' ;
		...
		$twitter = 'https://twitter.com/intent/tweet?text=Hey! Read this from my blog: ' . $title . '&amp;url=' . $permalink . $twitterHandler.'';
		$facebook = 'https://www.facebook.com/sharer/sharer.php?u=' . $permalink;
		$google = 'https://plus.google.com/share?url=' . $permalink;

		$content .= '<ul>';
		$content .= '<li><a href="' .$twitter. '" rel="nofollow"><span class="sunset-icon sunset-twitter"></span></a></li>';
...
function mailtrap($phpmailer) {
  ...
  $phpmailer->Port = 2525;
  $phpmailer->Username = 'd2e102d93ecb8c';
  $phpmailer->Password = '7d048ba14e4fd2';
}
